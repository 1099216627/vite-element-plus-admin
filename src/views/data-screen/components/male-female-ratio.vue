<template>
	...
	<div class="malefemaleRatio-main">
		<div class="malefemaleRatio-header">
			<div class="man">
				<span>男士</span>
				<img src="@/assets/images/data-screen/man.png" alt="" />
			</div>
			<div class="woman">
				<span>女士</span>
				<img src="@/assets/images/data-screen/woman.png" alt="" />
			</div>
		</div>
		<!-- echarts -->
...
.malefemaleRatio-main {
	...
	.malefemaleRatio-header {
		...
		.woman {
			...
			width: 110px;
			height: 115px;
			background: url("@/assets/images/data-screen/man-bg.png") no-repeat;
		...
		.woman {
			background: url("@/assets/images/data-screen/woman-bg.png") no-repeat;
		}
	}
	.echarts {
		width: 100%;
