	...
	<div class="login w-full h-full relative bg-cover">
		<div class="login-plane absolute flex items-center justify-evenly">
			<div class="login-plane-form">
				...
				<el-form :model="loginModel" size="large">
					<el-form-item> <el-input v-model="loginModel.username" placeholder="请输入用户名" :suffix-icon="User" /></el-form-item>
					<el-form-item>
				...
				<div class="flex justify-between">
					...
					<el-button class="w-[36%]" type="primary" @click="login">登录</el-button>
				</div>
			</div>
...
import { getCaptchaApi, registerApi } from "@/api/modules/user";
