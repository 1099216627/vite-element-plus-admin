...
<script setup lang="ts" name="BasicGrid">
import {
	ref,
	watch,
	useSlots,
...
import type { BreakPoint } from "@/components/basic/types";
...
const findIndex = () => {
	...
	slots.forEach((slot: any) => {
		if (typeof slot.type === "object" && slot.type.name === "BasicGridItem" && slot.props?.suffix !== undefined) suffix = slot;
